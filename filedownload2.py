...
url = 'https://ko.savefrom.net/222/'
output_file_path = './download_urls2.txt'
...
with open(output_file_path, 'w') as output_file:
    ...
    for line in lines:
        ...
        try:
            # 입력 필드에 텍스트 입력
            input_element = driver.find_element(By.CSS_SELECTOR, 'input[name="sf_url"]')
            input_element.send_keys(line)
            
            # 다운로드 버튼 클릭
            download_button = driver.find_element(By.CSS_SELECTOR, 'button[name="sf_submit"]')
