...
if __name__ == '__main__':
    input_file = 'security_download_links.txt'  # 다운로드 링크가 저장된 파일
    local_file_path = "downloaded_video.mp4"  # 다운로드된 파일의 임시 경로
    folder_id = '1LxcHaZOTr18ELZD_ht7jwQhpF_7Hm-gi'  # Google Drive 업로드 대상 폴더 ID
    episode_number = 62  # 회차 번호 초기값
        ...
        with open(input_file, 'r') as file:
            for line in file:
                ...
                try:
                    ...
                    # 2. 업로드 파일명 생성
                    file_name = f"정보보호론_{episode_number}.mp4"
